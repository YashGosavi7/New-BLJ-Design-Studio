      ...
      <div className="min-h-screen">
        ...
        >
          <div className="text-center max-w-5xl mx-auto flex flex-col justify-center items-center h-full px-4 md:px-6">
            ...
            <p className="text-lg md:text-xl lg:text-2xl text-white mb-8 md:mb-10 max-w-2xl mx-auto font-semibold drop-shadow-2xl leading-relaxed tracking-wide animate-fade-in" style={{ animationDelay: '0.2s' }}>
