      ...
      <div className="container mx-auto px-4 md:px-6">
        <div className="flex items-center justify-between h-20 md:h-24 lg:h-28">
          ...
          <Link to="/" className="flex items-center hover:opacity-90 transition-opacity mt-4 md:mt-5 lg:mt-6 -ml-6 md:-ml-8 lg:-ml-10">
            <img src={logoImage} alt="Balaji Design Studio" className="w-[160px] md:w-[190px] lg:w-[220px] h-auto object-contain brightness-105 rounded-md opacity-65 shadow-sm" />
          </Link>
